...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow-sm border p-6">
        <h1 class="text-2xl font-bold text-gray-900 mb-6">Créer un nouveau commentaire</h1>
            ...
            <div class="space-y-6 mb-6">
                ...
                <div>
                    ...
                    <textarea name="contenu_commentaire" id="contenu_commentaire" rows="6" required
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                              placeholder="Saisissez le commentaire...">{{ old('contenu_commentaire') }}</textarea>
