<x-app-layout>
    <x-slot name="title">Créer une Relation Région-Langue</x-slot>
    <x-slot name="subtitle">Associer une langue à une région</x-slot>

    <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-sm border border-gray-200/50 p-6">
        <form action="{{ route('admin.parler.store') }}" method="POST">
            @csrf
