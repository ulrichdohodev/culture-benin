    ...
    <div class="bg-white rounded-lg shadow-sm border p-6">
        <div class="flex justify-between items-start mb-6">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('admin.type-contenus.edit', $typeContenu) }}" 
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-lg font-medium text-gray-900">{{ $typeContenu->nom_contenu }}</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-900">{{ $typeContenu->created_at->format('d/m/Y à H:i') }}</p>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                @if($typeContenu->description)
                    <p class="text-sm text-gray-900">{{ $typeContenu->description }}</p>
                @else
        ...
        <div class="mt-8 pt-6 border-t">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="bg-blue-50 rounded-lg p-4 text-center">
                    <div class="text-blue-600 text-2xl font-bold">{{ $typeContenu->contenus_count }}</div>
